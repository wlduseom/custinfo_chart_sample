		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "회원 정보 분석",
									"targetURL": "#syncsapcustinfo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncsapcustinfo-display": {
								"semanticObject": "syncsapcustinfo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.sap.custinfo",
									"url": sap.ui.require.toUrl("sync/sap/custinfo")
								}
							}
						}
					}
